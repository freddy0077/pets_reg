        ...
        <header className="bg-white shadow-sm flex justify-between items-center p-4 mt-12">
            ...
            <div className="space-x-4 mt-5">
                <button
                    ...
                    className="bg-e84f25 text-white px-4 py-1.5 rounded ">Logout</button>
            </div>
        </header>
    );
}
            ...
            <div className="container mx-auto px-6 py-8">
                ...
                <div className={'mb-3 float-right'}>
                    <a href={'/vert-registration'}
                       className="bg-e84f25 text-white px-4 py-2 rounded transition duration-300">
                        Add New Doctor
                    </a>
                </div>
                <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {displayedDoctors?.length > 0 ? ( displayedDoctors?.map((doctor, index) => (
                        ...
                        <div className="col-span-full flex flex-col items-center justify-center py-12">
                            <svg
                                ...
                                className="h-16 w-16 text-gray-400" fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                            >
                                <path
                            ...
                            <p className="text-gray-500 mt-4 text-xl font-light text-center">No doctors available at the moment.</p>
                        </div>
                    }
                </div>
                ...
                <div className="mt-6 flex justify-center">
                    <button
                        className="mx-1 px-4 py-2 bg-fdbc0e text-white rounded"
