...
exports.create = exports.deleteTransaction = exports.update = exports.insert = exports.getAll = exports.get = void 0;
...
const deleteTransaction = (queryBuilder) => (input) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = input;
    if (!id) {
...
function create(data) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return {
            ...
            deleteTransaction: (0, exports.deleteTransaction)(plans),
        };
    });
}
