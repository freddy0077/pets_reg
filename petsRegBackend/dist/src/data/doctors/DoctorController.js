...
const DoctorData_1 = __importDefault(require("./DoctorData"));
...
const deleteDoctor = (users) => (input) => __awaiter(void 0, void 0, void 0, function* () {
    return users.deleteDoctor(input);
});
exports.deleteDoctor = deleteDoctor;
function create(data) {
    return __awaiter(this, void 0, void 0, function* () {
        const users = yield DoctorData_1.default.create(data);
        return {
            get: (0, exports.get)(users),
            getAll: (0, exports.getAll)(users),
            update: (0, exports.update)(users),
            insert: (0, exports.insert)(users),
            deleteDoctor: (0, exports.deleteDoctor)(users),
        };
    });
}
